            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                  ...
                  <path d="M14 6L22 14L14 22L6 14L14 6Z" fill="#111827" fillOpacity="0.5" />
                </svg>
              </div>
          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                a: 'MP4, GIF, WEBM. Под любой маркетплейс или соцсеть — подгоняю размер и соотношение сторон.',
              },
              {
              ...
              {
                q: 'Работаете с НДС?',
                a: 'Да, работаю как самозанятый. Предоставляю все закрывающие документы.',
              },
              {
